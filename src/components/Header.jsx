...
const Header = () => {
    return <div className="flex flex-col-reverse sm:flex-row items-start justify-between gap-3 md:gap-8" id="home">
        <div className="flex flex-col gap-2">
            ...
            <p className="max-w-[500px] text-lg md:text-xl"> I am an aspiring software developer who is born and raised on Oahu. I graduated from the University of Hawaii, class of 2023 with a Bachelor of Science in Computer Science (delete this).</p>
