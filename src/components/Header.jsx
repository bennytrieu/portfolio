...
const Header = () => {
    return <div className="flex flex-col-reverse sm:flex-row items-start justify-between gap-3 md:gap-8" id="home">
        <div className="flex flex-col gap-2">
            <h1 className="font-bold text-4xl sm:text-5xl md:text-6xl text-nowrap tracking-tighter mb-4">Hi, I'm <span className="bg-gradient-to-r from-red-500 to-black bg-clip-text text-transparent">Benny</span> 🙂
            </h1>
